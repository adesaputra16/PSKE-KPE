...
if ($input['TANGGAL_FILTER'] == "") {
  ...
  $sql_a = "SELECT * FROM KPE_AIR_FLOWMETER_OPERASIONAL_PRE WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_OPERASIONAL_PRE_TANGGAL>='".$tanggalbulankemaren."' AND KPE_AIR_FLOWMETER_OPERASIONAL_PRE_TANGGAL<='".$tahun."-".$bulan."-31' ";
} else {
