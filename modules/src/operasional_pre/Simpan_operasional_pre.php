...
if (empty($params['case']))
	...
	exit();
      ...
      $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_SUSUT_PROSES_PRE = ($KPE_AIR_FLOWMETER_OPERASIONAL_PRE_EFFESIENSI != "") ? $input['KPE_AIR_FLOWMETER_OPERASIONAL_PRE_EFFESIENSI'] - $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_PRE_EFFESIENSI'] + $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_PROSES_RW - $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_TOTAL_PROSES_PRE : "" ;

      $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_PAKAI_PRE = $result_e[0]['KPE_AIR_FLOWMETER_REKAP_USED_PRE_TOTAL'] - $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_CARBON_FILTER - $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_MESS - $KPE_AIR_FLOWMETER_OPERASIONAL_PRE_DRAIN_BACKWASH;
