...
$sql_d = "SELECT KPE_AIR_FLOWMETER_ID,KPE_AIR_FLOWMETER_NAMA,KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE 
          FROM KPE_AIR_FLOWMETER WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE='PRE' ORDER BY KPE_AIR_FLOWMETER_NAMA";
...
{
  $sql_h = "SELECT SUM(KPE_AIR_FLOWMETER_CATATAN_BEBAN) AS ACCUMULATIF_TOTAL
            FROM KPE_AIR_FLOWMETER_CATATAN 
            WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_CATATAN_TANGGAL>='".$tanggalAwal."-01' AND KPE_AIR_FLOWMETER_CATATAN_TANGGAL<='".$input['KPE_AIR_FLOWMETER_CATATAN_TANGGAL']."' AND RECORD_STATUS='A'";
  ...
  $sql_f = "SELECT SUM(KPE_AIR_FLOWMETER_CATATAN_BEBAN) AS TOTAL_USAGE
            FROM KPE_AIR_FLOWMETER_CATATAN 
            WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_CATATAN_TANGGAL='".$input['KPE_AIR_FLOWMETER_CATATAN_TANGGAL']."' AND RECORD_STATUS='A'";
