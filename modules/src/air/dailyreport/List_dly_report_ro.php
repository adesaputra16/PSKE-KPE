...
$sql_d = "SELECT KPE_AIR_FLOWMETER_ID,KPE_AIR_FLOWMETER_NAMA,KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE 
          FROM KPE_AIR_FLOWMETER WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE='RO' AND RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_DLY = 'Y' ORDER BY KPE_AIR_FLOWMETER_NAMA";

// $sql_d = "SELECT * FROM KPE_AIR_FLOWMETER_REKAP_USED_RO 
//           WHERE KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$input['KPE_AIR_FLOWMETER_CATATAN_TANGGAL']."' 
//           AND RECORD_STATUS='A'";
...
foreach($result_a as $r)
{
  ...
  $sql_h = "SELECT SUM(C.KPE_AIR_FLOWMETER_CATATAN_BEBAN) AS ACCUMULATIF_TOTAL
            ...
            WHERE C.RECORD_STATUS='A' AND C.KPE_AIR_FLOWMETER_CATATAN_TANGGAL>='".$tanggalAwal."-01' AND C.KPE_AIR_FLOWMETER_CATATAN_TANGGAL<='".$input['KPE_AIR_FLOWMETER_CATATAN_TANGGAL']."' AND C.RECORD_STATUS='A' AND F.RECORD_STATUS='A' AND F.KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE='RO' AND F.KPE_AIR_FLOWMETER_DLY='Y'";
  ...
  $sql_f = "SELECT SUM(C.KPE_AIR_FLOWMETER_CATATAN_BEBAN) AS TOTAL_USAGE
            FROM KPE_AIR_FLOWMETER_CATATAN AS C LEFT JOIN KPE_AIR_FLOWMETER AS F ON C.KPE_AIR_FLOWMETER_ID=F.KPE_AIR_FLOWMETER_ID
            WHERE C.RECORD_STATUS='A' AND C.KPE_AIR_FLOWMETER_CATATAN_TANGGAL='".$input['KPE_AIR_FLOWMETER_CATATAN_TANGGAL']."' AND C.RECORD_STATUS='A' AND F.RECORD_STATUS='A' AND F.KPE_AIR_FLOWMETER_DISTRIBUSI_TYPE='RO' AND F.KPE_AIR_FLOWMETER_DLY='Y'";
