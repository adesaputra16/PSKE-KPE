...
if($input['KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL'] != "" && $input['KPE_AIR_FLOWMETER_REKAP_USED_PRE_CODDING'] == "-")
{
...
} else 
{
  ...
  $this->MYSQL->dimana = "WHERE KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL='".$input['KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL']."'AND (RECORD_STATUS='A')";
