...
for($iy = $begin; $iy <= $end; $iy->modify('+1 day'))
{
  ...
  if (empty($input['MULTI_FILTER'])) {
    $sql_a = "SELECT KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL,KPE_AIR_FLOWMETER_REKAP_USED_PRE_BEBAN,KPE_AIR_FLOWMETER_NAMA,
              ...
              FROM KPE_AIR_FLOWMETER_REKAP_USED_PRE WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL='".$tglLaporan."' ORDER BY KPE_AIR_FLOWMETER_NAMA ASC";
  } else {
    $search_array = explode(",", $input['MULTI_FILTER']);
    $search_text = "'" . implode("', '", $search_array) . "'";
    $sql_a = "SELECT KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL,KPE_AIR_FLOWMETER_REKAP_USED_PRE_BEBAN,KPE_AIR_FLOWMETER_NAMA,
              KPE_AIR_FLOWMETER_REKAP_USED_PRE_CODDING,KPE_AIR_FLOWMETER_REKAP_USED_PRE_RATA_RATA,KPE_AIR_FLOWMETER_REKAP_USED_PRE_TOTAL 
              FROM KPE_AIR_FLOWMETER_REKAP_USED_PRE WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_ID IN (".$search_text.") AND KPE_AIR_FLOWMETER_REKAP_USED_PRE_TANGGAL='".$tglLaporan."' ORDER BY KPE_AIR_FLOWMETER_NAMA ASC";
  }
