...
if (empty($params['case']))
	...
	exit();
		...
		if ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1_BARU_HASIL'] != "") {
			$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_1 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1_BARU_HASIL'];
		} else {
			if ($KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1 == $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1']) {
				...
				if ($KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1 == 0) {
					...
					if ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'] == $tahun.'/'.$bulan.'/01') {
						...
						$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_1 = round(($KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1 - $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_1']),3);
					}
				}
			}
		}

		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_AKUMULASI_1 = ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'] == $tahun.'/'.$bulan.'/01') ? $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_1 + 0 : $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_1 + $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_AKUMULASI_1'] ;

		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_1 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_1'];

		if ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_1_BARU_HASIL'] != "") {
			$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_1 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_1_BARU_HASIL'];
		} else {
		...
		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_AKUMULASI_1 = ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'] == $tahun.'/'.$bulan.'/01') ? $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_1 + 0 : $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_1 + $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_AKUMULASI_1'] ;
		...
		if ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_2_BARU_HASIL'] != "") {
			$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_2 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_FLOW_2_BARU_HASIL'];
		} else {
		...
		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_AKUMULASI_2 = ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'] == $tahun.'/'.$bulan.'/01') ? $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_2 + 0 : $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_HASIL_2 + $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PROSES_AKUMULASI_2'] ;

		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_2 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_2'];

		if ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_2_BARU_HASIL'] != "") {
			$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_2 = $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_FLOW_2_BARU_HASIL'];
		} else {
		...
		$KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_AKUMULASI_2 = ($input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'] == $tahun.'/'.$bulan.'/01') ? $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_2 + 0 : $KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_HASIL_2 + $result_c[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_PRODUK_AKUMULASI_2'] ;
		...
		{
			$sql_d = "SELECT KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL FROM KPE_AIR_FLOWMETER_OPERASIONAL_RO WHERE KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL='".$input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL']."' AND RECORD_STATUS='A'";
			...
			if ($result_d >= 1) {
				...
				$sql_j = "SELECT KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL FROM KPE_AIR_FLOWMETER_OPERASIONAL_RO WHERE RECORD_STATUS='A' ORDER BY KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL DESC";

				$this->MYSQL = new MYSQL();
				$this->MYSQL->database = $this->CONFIG->mysql_koneksi()->db_nama;
				$this->MYSQL->queri = $sql_j;
				$result_j = $this->MYSQL->data()[0]['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL'];
				$datesebelumnya = Date('Y/m/d',strtotime($result_j.'+1 day'));
				if ($datesebelumnya != $input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL']) {
					$this->callback['respon']['pesan'] = "gagal";
					$this->callback['respon']['text_msg'] = "Tanggal $datesebelumnya Belum terisi";
				} else {
					$sql_i = "SELECT DISTINCT KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL FROM KPE_AIR_FLOWMETER_REKAP_USED_RO WHERE KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$input['KPE_AIR_FLOWMETER_OPERASIONAL_RO_TANGGAL']."' AND RECORD_STATUS='A' ORDER BY KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL DESC";

					$this->MYSQL = new MYSQL();
					$this->MYSQL->database = $this->CONFIG->mysql_koneksi()->db_nama;
					$this->MYSQL->queri = $sql_i;
					$result_i = $this->MYSQL->data()[0]['KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL'];
					$datesebelumnya = Date('Y/m/d',strtotime($result_j.'+1 day'));
					if ($result_i == "") {
						$this->callback['respon']['pesan'] = "gagal";
						$this->callback['respon']['text_msg'] = "Catatan tanggal $datesebelumnya belum direkap";
						$this->callback['result'] = $sql_i;
					} else {
						$data_master = array(
						...
						if ($this->MYSQL->simpan() == true)
						{
							...
							$this->callback['result']=$data_master;
						}
						else
						{
							$this->callback['respon']['pesan'] = "gagal";
				...
				if ($this->MYSQL->simpan() == true)
					{
							...
							$this->callback['result']=$data_master_ubah;
					}
					else
					{
					$this->callback['respon']['pesan'] = "gagal";
