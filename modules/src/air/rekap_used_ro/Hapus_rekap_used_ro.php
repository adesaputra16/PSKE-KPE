...
if($input['KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL'] != "" && $input['KPE_AIR_FLOWMETER_REKAP_USED_RO_CODDING'] == "-")
{
...
} else 
{
  ...
  $this->MYSQL->dimana = "WHERE KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$input['KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL']."'AND (RECORD_STATUS='A')";
