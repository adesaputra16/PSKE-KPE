...
for($iy = $begin; $iy <= $end; $iy->modify('+1 day'))
{
  ...
  $iys['TANGGAL_DEL']=Date("Y-m-d",strtotime($tglLaporan));
  $iys['NO']=$tglLaporans[2];

  $this->MYSQL=new MYSQL();
  $this->MYSQL->database=$this->CONFIG->mysql_koneksi()->db_nama;
  if (empty($input['MULTI_FILTER'])) {
    $sql_a = "SELECT KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL,KPE_AIR_FLOWMETER_REKAP_USED_RO_BEBAN,KPE_AIR_FLOWMETER_NAMA,
              KPE_AIR_FLOWMETER_REKAP_USED_RO_CODDING,KPE_AIR_FLOWMETER_REKAP_USED_RO_RATA_RATA,KPE_AIR_FLOWMETER_REKAP_USED_RO_TOTAL 
              FROM KPE_AIR_FLOWMETER_REKAP_USED_RO WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$tglLaporan."' ORDER BY KPE_AIR_FLOWMETER_NAMA ASC";
  } else {
    $search_array = explode(",", $input['MULTI_FILTER']);
    $search_text = "'" . implode("', '", $search_array) . "'";
    $sql_a = "SELECT KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL,KPE_AIR_FLOWMETER_REKAP_USED_RO_BEBAN,KPE_AIR_FLOWMETER_NAMA,
              KPE_AIR_FLOWMETER_REKAP_USED_RO_CODDING,KPE_AIR_FLOWMETER_REKAP_USED_RO_RATA_RATA,KPE_AIR_FLOWMETER_REKAP_USED_RO_TOTAL 
              FROM KPE_AIR_FLOWMETER_REKAP_USED_RO WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_ID IN (".$search_text.") AND KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$tglLaporan."' ORDER BY KPE_AIR_FLOWMETER_NAMA ASC";
  }
...
//       $this->MYSQL=new MYSQL();
//       $this->MYSQL->database=$this->CONFIG->mysql_koneksi()->db_nama;
//       $this->MYSQL->queri = "SELECT KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL,KPE_AIR_FLOWMETER_REKAP_USED_RO_BEBAN,KPE_AIR_FLOWMETER_NAMA,
//                              KPE_AIR_FLOWMETER_REKAP_USED_RO_CODDING,KPE_AIR_FLOWMETER_REKAP_USED_RO_RATA_RATA,KPE_AIR_FLOWMETER_REKAP_USED_RO_TOTAL 
//                              FROM KPE_AIR_FLOWMETER_REKAP_USED_RO WHERE RECORD_STATUS='A' AND KPE_AIR_FLOWMETER_REKAP_USED_RO_TANGGAL='".$tglLaporan."' AND KPE_AIR_FLOWMETER_ID='".$row_flow['KPE_AIR_FLOWMETER_ID']."'";
