...
foreach($result_a as $r)
{
  ...
  $this->MYSQL=new MYSQL();
  $this->MYSQL->database=$this->CONFIG->mysql_koneksi()->db_nama;
  $sql_e = "SELECT KPE_AIR_FLOWMETER_DEPARTEMEN_FLOW_ID,KPE_AIR_FLOWMETER_DEPARTEMEN_FLOW_NAMA,KPE_AIR_FLOWMETER_NAMA,KPE_AIR_FLOWMETER_ID,
            KPE_AIR_FLOWMETER_DEPARTEMEN_PERSONIL,KPE_AIR_FLOWMETER_DEPARTEMEN_TOTAL_PERSONIL,KPE_AIR_FLOWMETER_DEPARTEMEN_TOTAL_PERSEN,KPE_AIR_FLOWMETER_DEPARTEMEN_PERSONIL_HASIL
  ...
  $result_c=$this->MYSQL->data() ? : array(); 

  $r['DEPT_FLOW'] = $result_c;
  $r['NO'] = $no;
  $result[] = $r;
