...
if (empty($params['case']))
  ...
  {
    $sql_ca = "SELECT KPE_AIR_FLOWMETER_SUB_ID FROM KPE_AIR_FLOWMETER_SUB WHERE KPE_AIR_FLOWMETER_SUB_NAMA='".$input['KPE_AIR_FLOWMETER_SUB_NAMA']."' AND RECORD_STATUS='A'";
    ...
    if ($result_ca >= 1) {
      ...
      $this->callback['respon']['text_msg'] = "Sub Flowmeter sudah pernah di input";
    } else {
      $data_master = array(
