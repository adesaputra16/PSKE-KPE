...
KPE_KWH_CATATAN_BEBAN_X_READING,KPE_KWH_HARIAN_ENERGI_KWH_PERSEN,KPE_KWH_HARIAN_ENERGI_KWH_ACC,KPE_KWH_HARIAN_ENERGI_KWH_ACC_PERSEN,
KPE_KWH_HARIAN_ENERGI_SOLAR_PAKAI,KPE_KWH_HARIAN_ENERGI_SOLAR_ACC,KPE_KWH_FLOWMETER_READING,KPE_KWH_HARIAN_ENERGI_BATU_BARA_PAKAI,
KPE_KWH_HARIAN_ENERGI_BATU_BARA_ACC
FROM KPE_KWH_HARIAN_ENERGI WHERE RECORD_STATUS='A' AND KPE_KWH_HARIAN_ENERGI_TANGGAL='".$input['DATE']."'  
...
$sql_d = "SELECT KPE_KWH_FLOWMETER_NAMA,KPE_KWH_CATATAN_ANGKA,KPE_KWH_CATATAN_ANGKA_ESTIMASI,KPE_KWH_CATATAN_BEBAN,
KPE_KWH_CATATAN_BEBAN_X_READING,KPE_KWH_HARIAN_ENERGI_KWH_PERSEN,KPE_KWH_HARIAN_ENERGI_KWH_ACC,KPE_KWH_HARIAN_ENERGI_KWH_ACC_PERSEN,
KPE_KWH_HARIAN_ENERGI_SOLAR_PAKAI,KPE_KWH_HARIAN_ENERGI_SOLAR_ACC,KPE_KWH_FLOWMETER_READING,KPE_KWH_HARIAN_ENERGI_BATU_BARA_PAKAI,
KPE_KWH_HARIAN_ENERGI_BATU_BARA_ACC
FROM KPE_KWH_HARIAN_ENERGI WHERE RECORD_STATUS='A' AND KPE_KWH_HARIAN_ENERGI_TANGGAL='".$input['DATE']."'  
...
$sql_c = "SELECT KPE_KWH_DISTRIBUSI_ENERGI_PEMBEBANAN,KPE_KWH_DISTRIBUSI_ENERGI_DISTRIBUSI,KPE_KWH_DISTRIBUSI_ENERGI_TURBIN,
KPE_KWH_DISTRIBUSI_ENERGI_POWERHOUSE,KPE_KWH_DISTRIBUSI_ENERGI_SELISIH,KPE_KWH_DISTRIBUSI_ENERGI_SOLAR
FROM KPE_KWH_DISTRIBUSI_ENERGI WHERE RECORD_STATUS='A' AND KPE_KWH_DISTRIBUSI_ENERGI_TANGGAL='".$input['DATE']."'";
