            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control datepicker" id="KPE_AIR_FLOWMETER_OPERASIONAL_PRE_CODDING" name="KPE_AIR_FLOWMETER_OPERASIONAL_PRE_CODDING" autocomplete="off" readonly>
                </div>
                <div class="form-group">
  ...
  $('tbody').on('click', 'a.edit', function(){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        // console.log(KPE_AIR_FLOWMETER_OPERASIONAL_PRE_FILTERED_WATER_BASIN);
