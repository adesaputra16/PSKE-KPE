    ...
    { 
      {
        ...
        for (i = 0; i < data.result.length; i++) {
          ...
          nFlowmeter += /*html*/`<th class="bordered" height="57" colspan="3"><center>${data.result[i].KPE_AIR_FLOWMETER_NAMA}</center></th>`;
        ...
        if (data.respon.pesan == "sukses") 
        {
          ...
          $('#tujuan-light-pagination').pagination({
            ...
            listTotal = /*html*/`<tr class="total">
                                    <td class="text-center bordered"><b>Total:</b></td>
                                    ${totalCatatan}
                                  </tr>`;
